...
const features = [
  {
    ...
    copy:
      "TinyPay pairs a local hash-chain OTP engine with U2U Network so every payment remains single-use, verifiable, and fraud-proof—no cell towers required.",
    bulletPoints: [
  ...
  },
  {
    ...
    copy:
      "All balances live in a trust-minimized EVM smart contract. Users deposit once and transact freely knowing every OTP routes funds exactly once.",
    bulletPoints: [
      "Supports U2U, USDC, USDT, and any ERC20 asset",
      "Native token and ERC20 support side-by-side",
